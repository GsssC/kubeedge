...
import (
	...
	"github.com/kubeedge/kubeedge/edge/pkg/metamanager/apiserver-lite/storage/sqlite/imitator/watchhook"
...
type imitator struct {
	...
	// It is set when client init and is updated when a bigger resourceversion obj was saved into meta_v2
	revision uint64
	// to get obj resource version
...
func (s *imitator)InsertOrUpdateObj(ctx context.Context,obj runtime.Object) error{
	...
	s.lock.Unlock()
	klog.Infof("[apiserver-lite]successfully insert or update obj:%v",key)
	return nil
